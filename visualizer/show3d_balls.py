...
mousex, mousey, changed, showsz, zoom, changed
...
if __name__ == "__main__":
    ...
    dataset = PartNormalDataset(
        root=opt.data_dir, npoints=2048, split="test", normal_channel=False
    )
    idx = np.random.randint(0, len(dataset))  # FIXME: category is chosen by random
    data = dataset[idx]
