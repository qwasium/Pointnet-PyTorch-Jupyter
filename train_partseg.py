...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='pointnet_part_seg', help='model name [default: pointnet_part_seg]')
    parser.add_argument('--batch_size', type=int, default=16, help='batch Size during training [default: 16]')
    parser.add_argument('--epoch', default=251, type=int, help='epoch to run [default: 251]')
    parser.add_argument('--learning_rate', default=0.001, type=float, help='initial learning rate [default: 0.001]')
    parser.add_argument('--gpu', type=str, default='0', help='specify GPU devices [default: 0]')
    parser.add_argument('--optimizer', type=str, default='Adam', help='Adam or SGD [default: Adam]')
    parser.add_argument('--log_root', type=str, default='log', help='Log root directory [default: log]')
    ...
    parser.add_argument('--step_size', type=int, default=20, help='decay step for lr decay [default: 20]')
